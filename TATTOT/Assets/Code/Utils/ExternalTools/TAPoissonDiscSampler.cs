...
namespace Code.Utils.ExternalTools
{
    ...
    public class TAPoissonDiscSampler
    {
        ...
        public TAPoissonDiscSampler(float width, float height, float radius)
        {
        ...
        public IEnumerable<Vector2> Samples()
        {
            ...
            while (_activeSamples.Count > 0)
            {
                ...
                for (var j = 0; j < K; ++j)
                {
                    ...
                    var r = Mathf.Sqrt(Random.value * 3 * _radius2 + _radius2);
                ...
                if (found) continue;
                _activeSamples[i] = _activeSamples[^1];
        ...
        {
            var pos = new TAGridPos(sample, _cellSize);
        ...
        private readonly struct TAGridPos
        {
            public readonly int X;
            public readonly int Y;

            public TAGridPos(Vector2 sample, float cellSize)
            {
